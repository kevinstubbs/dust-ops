  ...
  return (
    <div className="py-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    ...
                    {!token.liquid && (
                      <span className="text-xs bg-red-600 px-2 py-1 rounded">Low Liquidity</span>
                    )}
                  </div>
      ...
      <button 
        ...
        className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 disabled:opacity-50 disabled:cursor-not-allowed px-6 py-4 rounded-xl font-semibold transition-all flex items-center justify-center"
      >
